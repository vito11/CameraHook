...
void *my_memcpy(void *_dst, const void *_src, unsigned len)
{
    ...
    if(update)
    {
       int result = I420Scale(y,picWidth,u,picWidth/2,v,picWidth/2,picWidth,picHeight,_y,previewWidth,_u,previewWidth/2,_v,previewWidth/2,previewWidth,previewHeight,kFilterNone);
